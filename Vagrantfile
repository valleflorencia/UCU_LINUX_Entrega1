# INTEGRANTES: Florencia Valle - Bruno Lorenzo
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    mkdir /home/ucu/.ssh
    cp /vagrant/files/id_rsa /home/ucu/.ssh
    cp /vagrant/files/id_rsa.pub /home/ucu/.ssh
    cp /vagrant/files/id_rsa.pub /home/ucu/.ssh/authorized_keys
